			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - Authorised Customer Care</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML Sitemap - Authorised Customer Care</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="content">
							...
							<p class="expl">
								<a href="http://localhost:4009/sitemap_index.xml">&#8592; Sitemap Index</a>							</p>
